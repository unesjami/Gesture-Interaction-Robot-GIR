...
👀 Eye control + turn on/off with double clap 
...
Hardware: Arduino Uno R3, Servo Motors (Hands, Head, Body), DFPlayer Mini (Audio module), Microphone Sensor (Clap detection), EEPROM (State memory)
